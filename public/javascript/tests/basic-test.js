    ...
    "File operations": {
      ...
      "file action operations": {
        setUp: function() {
          ...
          this.action1 = Help.createAction(this.actionId);
          this.action2 = Help.createAction(this.actionId + "2");
        },
        ...
        "remote actions": {
          setUp: function() {
            this.action3 = Help.createAction(this.actionId + "3");
            this.action4 = Help.createAction(this.actionId + "4");
            Help.indexify([this.action3, this.action4], 0);

            this.action5 = Help.createAction(this.actionId + "5");
