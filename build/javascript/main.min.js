...
define('dataBacking/localBacking',["dataBacking/baseBacking"], function(BaseBacking) {
...
define('dataBacking/indexedDBBacking',["helpers", "dataBacking/localBacking", "db"], function(Helpers, LocalBacking, db) {
...
define('dataBacking/webSQLBacking',["dataBacking/localBacking"], function(LocalBacking) {
...
define('dataBacking/driveBacking',["dataBacking/baseBacking", "db"], function(BaseBacking, db) {
...
define('data',["class", "helpers", "event", "dataBacking/indexedDBBacking", "dataBacking/webSQLBacking", "dataBacking/driveBacking", "event"], function(Class, Helpers, Event, IndexedDBBacking, WebSQLBacking, DriveBacking, Event) {
...
define('sections/fileList',["section", "tapHandler", "event", "globals", "helpers", "data", "templates/fileList", "components/thumbnail"], function(Section, TapHandler, Event, g, Helpers, Data, FileListTemplate, Thumbnail) {
...
define('dataLayer/file',["class"], function(Class) {
  var File = Class.extend({
    ...
    rename: function(fileId, newFileName) {
      console.error("Implement this function");
    },
...
define('dataLayer/IndexedDBBacking',["class", "helpers", "db"], function(Class, Helpers, db) {
...
define('dataLayer/data',["class", "helpers", "event", "dataLayer/file", "dataLayer/IndexedDBBacking"], function(Class, Helpers, Event, File, IndexedDBBacking) {
  var Data = Class.extend({
    _backing: null,
    _cachedFiles: null,
