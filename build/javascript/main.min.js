...
*/
  ...
  (function(B) {
    ...
    "function" === typeof define && typeof define.amd ? define('vendor/sha256',[],function() {
      return r
    }) : "undefined" !== typeof exports ? "undefined" !== typeof module && module.exports ? module.exports = exports = r : exports = r : B.jsSHA = r
  })(this);
define('gauth',["class", "event", "vendor/sha256"], function(Class, Event, jsSHA) {
...
define('components/thumbnail',["class", "globals", "helpers", "components/drawCanvas"], function(Class, g, Helpers, DrawCanvas) {
...
define('analytics',["event"], function(Event) {
  function Analytics() {
    this.init();
  };
...
define('page',["section", "analytics"], function(Section, Analytics) {
...
define('sections/login',["event", "page", "tapHandler", "online", "gauth", "data"], function(Event, Page, TapHandler, Online, GAuth, Data) {
...
define('managers/modal',["section", "tapHandler"], function(Section, TapHandler) {
...
define('components/modalBase',["section", "managers/modal", "tapHandler", "analytics"], function(Section, ModalManager, TapHandler, Analytics) {
...
define('modals/share',["components/modalBase", "tapHandler", "data", "event", "online", "platform", "gauth", "analytics"], function(ModalBase, tapHandler, Data, Event, Online, Platform, GAuth, Analytics) {
...
define('modals/delete',["components/modalBase", "tapHandler", "data", "analytics"], function(ModalBase, tapHandler, Data, Analytics) {
...
define('sections/fileItem',["section", "tapHandler", "analytics", "event", "globals", "helpers", "platform", "template", "online", "gauth", "data", "modals/share", "modals/delete"], function(Section, TapHandler, Analytics, Event, g, Helpers, Platform, Template, Online, GAuth, Data, ShareModal, DeleteModal) {
...
define('sections/fileList',["page", "tapHandler", "analytics", "event", "globals", "helpers", "online", "gauth", "sections/statusIndicator", "sections/fileItem", "data"], function(Page, TapHandler, Analytics, Event, g, Helpers, Online, GAuth, StatusIndicator, FileItem, Data) {
...
define('modals/loading',["components/modalBase", "tapHandler", "data", "analytics"], function(ModalBase, tapHandler, Data, Analytics) {
...
define('sections/draw',["page", "globals", "event", "helpers", "tapHandler", "platform", "db", "bezierCurve", "smooth", "data", "online", "components/drawCanvas", "analytics", "modals/loading"], function(Page, g, Event, Helpers, TapHandler, Platform, db, BezierCurve, Smooth, Data, Online, DrawCanvas, Analytics, LoadingModal) {
