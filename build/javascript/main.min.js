...
define('components/modalBase',["section", "managers/modal", "tapHandler"], function(Section, ModalManager, TapHandler) {
...
define('modals/share',["components/modalBase", "tapHandler", "data", "event", "online", "platform", "gauth"], function(ModalBase, tapHandler, Data, Event, Online, Platform, GAuth) {
...
define('modals/delete',["components/modalBase", "tapHandler", "data"], function(ModalBase, tapHandler, Data) {
...
define('sections/fileList',["section", "tapHandler", "analytics", "event", "globals", "helpers", "online", "gauth", "sections/statusIndicator", "sections/fileItem", "data", "modals/share", "modals/delete"], function(Section, TapHandler, Analytics, Event, g, Helpers, Online, GAuth, StatusIndicator, FileItem, Data, ShareModal, DeleteModal) {
      ...
      Data.getFiles()
        .then((function(files) {
          for (var i = 0; i < files.length; i++) {
            ...
            if (i == 0) {
              // ShareModal.show(fileInfo);
              //DeleteModal.show(fileInfo);
            }
          }
